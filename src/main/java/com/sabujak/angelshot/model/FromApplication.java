...
public class FromApplication {
	...
	public String getStart_CallSer() {
		return start_CallSer;
	}
	public void setStart_CallSer(String start_CallSer) {
		this.start_CallSer = start_CallSer;
	}
